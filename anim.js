...
var lyricsData = [
  ...
  { text: "♫ Y LA LUZ ENCUENTRO AL FIIIINNN ♫", time: 47 },
  ...
  { text: "...", time: 73 },
  { text: "Te acuerdas que me preguntastes sobre canciones..", time: 77 },
  { text: "Las cuales me recuerdan a ti", time: 81 },
  { text: "Esta canción es una de ellas", time: 85 },
  { text: "Cada vez que la escucho", time: 89 },
  { text: "Pienso en nosotros <3", time: 93 },
  { text: "<3 <3 <3", time: 96 },
  { text: "Hay dias que recuerdo el pasado..", time: 99 },
  { text: "Cuando no hablábamos, pensaba en..", time: 101 },
  { text: "Si algún dia iba a encontrar, a alguien como tú", time: 105 },
  ...
  { text: "Si cerca estás, es fácil ver", time: 140 },
